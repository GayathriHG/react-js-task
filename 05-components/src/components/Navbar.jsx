  ...
  return (
    <>
      <div className="bg-[#0E1428] font-NotoSansJP text-2xl text-white  px-20 py-6 flex items-center justify-between">
        Components
        <div className="px-20 space-x-6 text-sm flex items-center">
          <Link to={"/"}>
