const Navbar = () => {
    return<>
    <div className="bg-orange-400 flex items-center justify-between px-20 py-4 font-serif text-2xl">
      Form  
      <a href="https://github.com/GayathriHG/react-js-tasks/tree/main/06-form" target="blank">
